...
defaults write NSGlobalDomain AppleLanguages -array "en-CA" "en-US"
defaults write NSGlobalDomain AppleLocale -string "en_CA@calendar=iso8601"
...
# Disable magnification of Dock items on hover
